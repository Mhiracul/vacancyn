...
const Hero = () => {
  ...
  return (
    <div
      className="relative font-outfit bg-white bg-cover bg-center bg-no-repeat shadow flex flex-col justify-center"
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="block md:hidden">
            <h2 className="text-3xl font-semibold text-gray-900 mb-3">
              There Are <span className="text-[#0867bc] font-bold">10,000</span>{" "}
