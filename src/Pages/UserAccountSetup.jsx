  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50 px-4 py-8 2xl:px-20 flex flex-col items-center font-outfit">
        <div className="2xl:px-20 px-4 mx-auto container flex w-full  justify-between items-center">
        ...
        <div className="w-full 2xl:px-20 px-4 py-4 container mx-auto bg-white shadow-sm mt-10 rounded-lg  relative">
          {/* Tabs */}
          <div className="flex gap-4 md:gap-6 border-b border-gray-200 mb-6 text-sm font-medium">
            {[
              ...
              <button
                ...
                className={`pb-3 md:text-sm text-xs outline-none whitespace-nowrap ${
                  activeTab === tab.key
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <FineSelect
                  ...
                  onChange={(val) =>
                    setUserData({ ...userData, education: val })
                  }
                ...
                <FineSelect
                  ...
                  onChange={(val) =>
                    setUserData({ ...userData, experience: val })
                  }
